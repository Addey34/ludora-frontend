...
const BASE_CATALOG: Record<Locale, Record<string, string>> = {
  en: {
    ...
    weeklyChallengeTip: 'Weekly challenge — this game earns ×{mult} GamesZone Points this week.',
    hudStatus: 'Status',
    hudRound: 'Round',
  ...
  fr: {
    ...
    weeklyChallengeTip: 'Défi hebdo — ce jeu rapporte ×{mult} points GamesZone cette semaine.',
    hudStatus: 'État',
    hudRound: 'Manche',
    hudQuestion: 'Question',
    hudLines: 'Lignes',
