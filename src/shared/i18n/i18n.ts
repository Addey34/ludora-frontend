...
const BASE_CATALOG: Record<Locale, Record<string, string>> = {
  en: {
    ...
    youWon: 'You won!',
    draw: 'Draw!',
    millCapture: "Mill! Remove one of your opponent's pieces.",
    score: 'Score',
    ...
    asteroidsRecap:
      '<p>You reached wave <strong>{level}</strong> with <strong>{score}</strong> points.</p>',
    asteroidsCanvasLabel: 'Asteroids game arena',
    asteroidsTouchControls: 'Touch controls',
    asteroidsTurnLeft: 'Turn left',
    asteroidsTurnRight: 'Turn right',
    asteroidsThrust: 'Thrust',
    asteroidsShoot: 'Fire',
    quoridorToolLabel: 'Move type',
    quoridorPawn: 'Pawn',
    quoridorHorizontalWall: 'Horizontal wall',
    quoridorVerticalWall: 'Vertical wall',
    quoridorWallsYou: 'Your walls',
    quoridorWallsOpponent: 'Opponent walls',
    quoridorBoardLabel: 'Quoridor board',
    quoridorSquare: 'Square, row {row}, column {column}',
    quoridorWallSlot: '{orientation}, row {row}, column {column}',
    quoridorWinRecap: 'You reached the opposite side first — route mastered!',
    quoridorLoseRecap: 'The opponent reached your side first. Try another route!',
    scienceTopic: 'Topic',
    scienceAllTopics: 'All topics',
    ...
    scienceEarth: 'Earth',
    quizCorrect: 'Correct!',
    quizAnswer: 'Answer: {answer}{note}',
    whackBoardLabel: 'Whack-a-Mole board',
    whackHole: 'Hole {number}',
    whackMoleAt: 'Mole in hole {number}',
    whackGoldenMoleAt: 'Golden mole in hole {number}',
    whackDuration: 'Duration',
    whackHits: 'Hits',
    whackMisses: 'Misses',
    whackRecap: '<p><strong>{score}</strong> points · {hits} hits · best streak: {streak}</p>',
    ...
    allGames: 'All games',
    homeEyebrow: 'Instant browser games',
    homeTitle: 'Pick a game and jump in.',
    homeIntro: 'No download, no waiting — discover a new favourite in seconds.',
    searchGames: 'Search games',
    clearSearch: 'Clear search',
    searchResults: 'Search results',
    searchResultsKicker: 'Matching games',
    featuredKicker: 'Fresh picks',
    featuredTitle: 'In the spotlight',
    featuredIntro: 'Today’s featured game and this week’s rewarding picks.',
    recentlyPlayedKicker: 'Jump back in',
    recentlyPlayedTitle: 'Recently played',
    favoritesKicker: 'Your collection',
    favoritesTitle: 'Favorites',
    addToFavorites: 'Add {game} to favorites',
    removeFromFavorites: 'Remove {game} from favorites',
    newGamesKicker: 'Just landed',
    newGamesTitle: 'New games',
    browseKicker: 'Find your next game',
    gameCategories: 'Game categories',
    gameShown: '1 game',
    gamesShown: '{count} games',
    ...
    hudMyTiles: 'Your tiles',
    hudBotTiles: 'Opponent tiles',
    hudBoneyard: 'Boneyard',
    dominoDrawTile: 'Draw a tile',
    dominoPass: 'Pass',
    dominoPlaceLeft: 'Place on the left end',
    dominoPlaceRight: 'Place on the right end',
    dominoBlocked: 'Blocked game — lowest pip count wins',
    hudLives: 'Lives',
    hudLevel: 'Level',
    bkWorld: 'World',
    hudStreak: 'Streak',
    dailyStreak: 'Daily streak: {n} 🔥',
    spotlightDaily: 'Game of the day — earn Ludora Points here today.',
    spotlightWeekly: 'Game of the week — earn Ludora Points here this week.',
    hudStatus: 'Status',
    hudRound: 'Round',
  ...
  fr: {
    ...
    youWon: 'Gagné !',
    draw: 'Égalité !',
    millCapture: 'Moulin ! Retire une pièce adverse.',
    score: 'Score',
    scoreValue: 'Score : {score}',
    ...
    asteroidsRecap:
      '<p>Tu as atteint la vague <strong>{level}</strong> avec <strong>{score}</strong> points.</p>',
    asteroidsCanvasLabel: 'Arène du jeu Astéroïdes',
    asteroidsTouchControls: 'Commandes tactiles',
    asteroidsTurnLeft: 'Tourner à gauche',
    asteroidsTurnRight: 'Tourner à droite',
    asteroidsThrust: 'Propulser',
    asteroidsShoot: 'Tirer',
    quoridorToolLabel: 'Type de coup',
    quoridorPawn: 'Pion',
    quoridorHorizontalWall: 'Barrière horizontale',
    quoridorVerticalWall: 'Barrière verticale',
    quoridorWallsYou: 'Tes barrières',
    quoridorWallsOpponent: 'Barrières adverses',
    quoridorBoardLabel: 'Plateau de Quoridor',
    quoridorSquare: 'Case, ligne {row}, colonne {column}',
    quoridorWallSlot: '{orientation}, ligne {row}, colonne {column}',
    quoridorWinRecap: 'Tu as atteint le côté opposé en premier — parcours maîtrisé !',
    quoridorLoseRecap: 'L’adversaire a atteint ton côté en premier. Tente un autre chemin !',
    scienceTopic: 'Thème',
    scienceAllTopics: 'Tous les thèmes',
    scienceBiology: 'Biologie',
    scienceChemistry: 'Chimie',
    sciencePhysics: 'Physique',
    scienceSpace: 'Espace',
    scienceEarth: 'Terre',
    quizCorrect: 'Bonne réponse !',
    quizAnswer: 'Réponse : {answer}{note}',
    whackBoardLabel: 'Plateau de Tape-taupe',
    whackHole: 'Trou {number}',
    whackMoleAt: 'Taupe dans le trou {number}',
    whackGoldenMoleAt: 'Taupe dorée dans le trou {number}',
    whackDuration: 'Durée',
    whackHits: 'Touches',
    whackMisses: 'Ratés',
    whackRecap:
      '<p><strong>{score}</strong> points · {hits} touches · meilleure série : {streak}</p>',
    ...
    homeEyebrow: 'Jeux navigateur instantanés',
    homeTitle: 'Choisis un jeu et lance-toi.',
    homeIntro:
      'Aucun téléchargement, aucune attente — découvre ton prochain jeu en quelques secondes.',
    searchGames: 'Rechercher un jeu',
    clearSearch: 'Effacer la recherche',
    searchResults: 'Résultats de recherche',
    searchResultsKicker: 'Jeux correspondants',
    featuredKicker: 'Sélection du moment',
    featuredTitle: 'À la une',
    featuredIntro: 'Le jeu du jour et les sélections qui rapportent cette semaine.',
    recentlyPlayedKicker: 'Reprends ta partie',
    recentlyPlayedTitle: 'Joués récemment',
    favoritesKicker: 'Ta collection',
    favoritesTitle: 'Favoris',
    addToFavorites: 'Ajouter {game} aux favoris',
    removeFromFavorites: 'Retirer {game} des favoris',
    newGamesKicker: 'Tout juste arrivés',
    newGamesTitle: 'Nouveautés',
    browseKicker: 'Trouve ton prochain jeu',
    gameCategories: 'Catégories de jeux',
    gameShown: '1 jeu',
    gamesShown: '{count} jeux',
    noGamesFound: 'Aucun jeu ne correspond à ta recherche.',
    ...
    hudBorneOff: 'Sortis',
    hudMyTiles: 'Vos dominos',
    hudBotTiles: 'Dominos adverses',
    hudBoneyard: 'Pioche',
    dominoDrawTile: 'Piocher un domino',
    dominoPass: 'Passer',
    dominoPlaceLeft: "Placer à l'extrémité gauche",
    dominoPlaceRight: "Placer à l'extrémité droite",
    dominoBlocked: 'Jeu bloqué — le moins de points gagne',
    hudLives: 'Vies',
    hudLevel: 'Niveau',
    bkWorld: 'Monde',
    hudStreak: 'Série',
    dailyStreak: 'Série quotidienne : {n} 🔥',
    spotlightDaily: 'Jeu du jour — gagne des points Ludora ici aujourd’hui.',
    spotlightWeekly: 'Jeu de la semaine — gagne des points Ludora ici cette semaine.',
    hudStatus: 'État',
    hudRound: 'Manche',
    hudQuestion: 'Question',
    hudLines: 'Lignes',
...
const CONTROLS_FR: Record<string, string> = {
  ...
  '<kbd>↑</kbd> or <kbd>W/Z</kbd>': '<kbd>↑</kbd> ou <kbd>W/Z</kbd>',
  '<kbd>Space</kbd> / touch button': '<kbd>Espace</kbd> / bouton tactile',
  ...
  'Click / tap': 'Clic / tap',
  'Play a matching tile': 'Poser un domino compatible',
  'Draw pile': 'Pioche',
  'Draw when you cannot play': 'Piochez quand vous ne pouvez pas jouer',
  ...
  Walls: 'Barrières',
  'Choose a highlighted square': 'Choisis une case surlignée',
  'Choose pawn movement or a wall orientation':
    'Choisis le déplacement du pion ou l’orientation d’une barrière',
  'Block a route without sealing every path': 'Bloque un passage sans fermer tous les chemins',
  'Reach the opposite side first': 'Atteins le côté opposé en premier',
  'Choose a science topic, difficulty and mode':
    'Choisis un thème scientifique, une difficulté et un mode',
  'Master biology, chemistry, physics, space and Earth science':
    'Maîtrise la biologie, la chimie, la physique, l’espace et les sciences de la Terre',
  'Click / tap or <kbd>1–9</kbd>': 'Clic / toucher ou <kbd>1–9</kbd>',
  'Whack the visible mole': 'Tape la taupe visible',
  'Golden mole': 'Taupe dorée',
  'Worth extra points': 'Rapporte des points supplémentaires',
  Miss: 'Raté',
  'A missed mole or wrong hole breaks the streak':
    'Une taupe ratée ou un mauvais trou brise la série',
  'Build the highest score before time runs out': 'Obtiens le meilleur score avant la fin du temps',
  'Turn the ship': 'Tourne le vaisseau',
  Thrust: 'Propulser',
  Fire: 'Tirer',
  'Destroy the asteroids and survive each wave': 'Détruis les astéroïdes et survis à chaque vague',
  ...
  Place: 'Poser',
  'Drop your nine pieces on the board': 'Place tes neuf pions sur le plateau',
  'Then slide a piece to an adjacent spot': 'Puis glisse un pion vers une case voisine',
  Mill: 'Moulin',
  'Line up three to remove an enemy piece': 'Aligne-en trois pour retirer un pion adverse',
  'Reduce your opponent to two pieces': "Réduis l'adversaire à deux pions",
  Rotate: 'Tourner',
