...
const BASE_CATALOG: Record<Locale, Record<string, string>> = {
  en: {
    ...
    themePortal: 'Default dark',
    themeArcade: 'Neon arcade',
    themeConsole: 'Console dark',
    themeEsports: 'Esports light',
    themeCards: 'Cards light',
    ...
    dailyChallengeSub: 'One shared puzzle a day — keep your streak alive.',
    weeklySpotlightTitle: 'Weekly spotlight',
    weeklySpotlightSub: '{game} earns ×{mult} GamesZone Points this week.',
    hudStatus: 'Status',
    hudRound: 'Round',
  ...
  fr: {
    ...
    themePortal: 'Sombre par défaut',
    themeArcade: 'Arcade néon',
    themeConsole: 'Console sombre',
    themeEsports: 'Esport clair',
    themeCards: 'Cartes clair',
    home: 'Accueil',
    profileTitle: 'Profil',
    ...
    dailyChallengeSub: 'Un puzzle partagé chaque jour — garde ta série en vie.',
    weeklySpotlightTitle: 'À la une cette semaine',
    weeklySpotlightSub: '{game} rapporte ×{mult} points GamesZone cette semaine.',
    hudStatus: 'État',
    hudRound: 'Manche',
    hudQuestion: 'Question',
    hudLines: 'Lignes',
